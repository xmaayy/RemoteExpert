...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    {
        /// <summary>
        /// Handles the state of all of the objects in the scene
        /// </summary>
        ...
        private void OnDataChannelAdded(WebRTC.DataChannel channel)
        {
            print("data channel added");
            // set up what happens when we receive a request
